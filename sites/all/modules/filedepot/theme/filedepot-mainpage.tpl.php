...
<script type="text/javascript">
  ...
  if(show_upload == false && show_newfolder == false){
//	console.log(show_upload,show_newfolder);
//	document.getElementsByClassName('filedepottoolbar').style.display = "none";
  }
</script>
...
<div id="filedepotmodule">
  ...
  <div id="filedepot" style="background-color:#EBEFF0">
      ...
      <div class="filedepottoolbar_searchbox">
        <div class="filedepottoolbar_searchform">
          <form name="fsearch" onSubmit="makeAJAXSearch();return false;">
            ...
            <table>
              <tr><!--margin-top:-2px;padding:3px 3px 5px 3px;-->
                <td width="50%"><input type="text" size="20" name="query" id="searchquery" class="form-text" style="" value="<?php print $search_query ?>" onClick="this.value='';"></td>
