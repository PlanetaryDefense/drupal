...
<table class="plugin" width="100%" border="0" cellspacing="0" cellpadding="2" style="padding-bottom:10px;">
	...
	<!--<a href="<?php print url('filedepot', array('query' => array('cid' => $cid, 'fid' => $fid), 'absolute' => true)); ?>" ti
tle="<?php print t('Direct link to file'); ?>" <?php print $disable_download ?>><strong><?php print $filetitle ?></strong></a>-->
            <div style="padding-bottom:10px;"><img src="<?php print $fileicon; ?>">&nbsp;<strong><?php print pathinfo($filetitle, PATHINFO_FILENAME) ?></strong>
<!--&nbsp;<span style="font-size:8pt;"><?php print $current_version ?></span>-->
</div>
          <?php } ?>
            ...
            <div class="clearboth"></div>
            <div class="floatleft" style="width:100px;"><strong><?php print t('Uploaded By'); ?>:</strong></div>
	    ...
	    <div class="floatleft" style="width:100px;"><strong><?php print t('Author'); ?>:</strong></div>
            <div class="floatleft" style="font-size:9pt;"><?php print $author_names ?></div>
            <div class="clearboth"></div>
