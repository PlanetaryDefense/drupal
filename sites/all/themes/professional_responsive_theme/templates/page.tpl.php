...
<div id="header_wrapper">
  <header id="header" role="banner">
    ...
    <?php endif; ?>
    <h1 id="site-title">
      <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">PLANETARY DEFENSE (PD) FRAMEWORK GATEWAY</a>
...
<div id="footer">
  ...
  <div class="footer_credit">
    ...
    <div id="copyright">
     <span class="copyright">This system is funded by NASA Goddard and NSF (NNG16PU001), and supported by NASA AIST (NNX15AM85G). Developed and hosted by NSF Spatiotemporal Innovation Center on the Hybrid Cloud Service.</span>
